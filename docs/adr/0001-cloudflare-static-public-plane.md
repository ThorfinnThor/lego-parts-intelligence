...
This supersedes the originally supplied hosting target and avoids public Supabase dependency. It also avoids D1/KV/R2 runtime reads, uses no Worker CPU, and makes deployments atomic at the asset-version boundary. Preview and production deployments are Cloudflare-only.
